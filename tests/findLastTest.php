...
class findLastTest extends PHPUnit_Framework_TestCase
{
	...
	{
		$findLast = Dash\_findLast($predicate);
		$this->assertEquals($expected, $findLast($iterable));
	}
	...
	public function cases()
	{
		return [
			...
			'With an indexed array and matchesProperty($field) shorthand' => [
				...
				'predicate' => 'active',
				'expected' => [3, ['name' => 'Pete', 'age' => 35, 'gender' => 'male', 'active' => true]],
			],
			'With an indexed array and matchesProperty($field, $value) shorthand' => [
				...
				'expected' => [2, ['name' => 'Kane', 'age' => 33, 'gender' => 'male', 'active' => false]],
			],
			...
			'With an associative array and matchesProperty($field) shorthand' => [
				...
				'predicate' => 'active',
				'expected' => ['d', ['name' => 'Pete', 'age' => 35, 'gender' => 'male', 'active' => true]],
			],
			'With an associative array and matchesProperty($field, $value) shorthand' => [
				...
				'predicate' => ['active', false],
				'expected' => ['c', ['name' => 'Kane', 'age' => 33, 'gender' => 'male', 'active' => false]],
			],
			...
			'With an stdClass and matchesProperty($field) shorthand' => [
				...
				'predicate' => 'active',
				'expected' => ['d', (object) ['name' => 'Pete', 'age' => 35, 'gender' => 'male', 'active' => true]],
			],
			'With an stdClass and matchesProperty($field, $value) shorthand' => [
				...
				'predicate' => ['active', false],
				'expected' => ['c', (object) ['name' => 'Kane', 'age' => 33, 'gender' => 'male', 'active' => false]],
			],
			...
			'With an ArrayObject and matchesProperty($field) shorthand' => [
				...
				'expected' => [
					'd',
					new ArrayObject(['name' => 'Pete', 'age' => 35, 'gender' => 'male', 'active' => true])
				],
			],
			'With an ArrayObject and matchesProperty($field, $value) shorthand' => [
				...
				'expected' => [
					'c',
					new ArrayObject(['name' => 'Kane', 'age' => 33, 'gender' => 'male', 'active' => false])
				],
			],
		];
	}
	...
	public function testPredicateArgs()
	{
		...
		$result = Dash\findLast($iterable, $predicate);
	...
	{
		$this->assertSame($expected, Dash\findLast($iterable));
	}
